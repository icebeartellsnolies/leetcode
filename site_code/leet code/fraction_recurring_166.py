# def recurring(numerator, denominator):
#     ans=numerator/denominator
#     if int(ans)==ans:
#         return ans
#     whole_part, dec_part=str(ans).split('.')
#     for i in range(len(dec_part)):
#         prev_part=dec_part[:i,-1]
#         if dec_part[i] in prev_part:
#             for index in range(len(prev_part)):
#                 if prev_part[index] == dec_part[i]:
